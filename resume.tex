...
\noindent\rule{\textwidth}{\hlinewidth}
    \begin{innerlist}
        ...
        \item SolidWorks, NX, Teamcenter, Onshape, Abaqus, AutoCAD, GIMP, Inkscape
...
\href{https://github.com/Joedang}{github.com/Joedang}.
	\begin{innerlist}
    \item iTopie printer \\
    Modified and built a RepRap-based 3D printer from individually sourced parts including a laser-cut frame

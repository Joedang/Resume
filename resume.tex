...
\begin{innerlist}
	...
	\item Mechanical Lead, \href{http://pacificdt.com/}{Pacific Diabetes Technologies}
		\hfill\textbf{Sep. 2018 - Mar. 2019} %remember to add links to these things
...
\noindent\rule{\textwidth}{\hlinewidth}
	...
	\item Mechanical Lead, PSAS
		\hfill\textbf{Dec. 2015 -- Mar. 2019, Sep. 2019 -- present} %remember to add links to these things
...
\noindent\rule{\textwidth}{\hlinewidth}
    \begin{innerlist}
        \item R, MATLAB, C++, Python, Bash, Vim, Git, SolidWorks, NX, Abaqus, AutoCAD, GIMP, Inkscape
